...
{% hint style="info" %}
Na seção de [Carta de cotação e proposta](documentos/carta-de-cotacao-e-proposta.md) são endpoint para retornar um base64 para gerar os PDFs references ao status da cotação.
{% endhint %}
